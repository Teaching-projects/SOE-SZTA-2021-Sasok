...
public class MainTest {
    ...
    void test2() {
        ...
        Main.battle(unit1, unit2);
        Assertions.assertEquals(95, unit2.getHp(), "Shaman has less or more hp than it should");
    }

    @Test
    @DisplayName("Test for battle function")
    void test3() {
        unit1 = new Unit("harcos", 10, 100, 1.5);
        unit2 = new Unit("saman", 2, 100, 1.5);
        Main.battle(unit1, unit2);
        Assertions.assertEquals(82, unit1.getHp(), "Harcos has less or more hp than it should");
    }
